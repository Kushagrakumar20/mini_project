...
//                 hostelWardenMap.push({ ...warden._doc, ...hostel._doc });
//             } else {
//                 console.warn(`⚠️ No warden found for hostel: ${hostel.name}, warden email: ${hostel.warden}`);
//             }
//         }
